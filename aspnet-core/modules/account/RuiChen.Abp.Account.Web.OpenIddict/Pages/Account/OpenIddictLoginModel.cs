using RuiChen.Abp.Account.Web.ExternalProviders;
...
namespace RuiChen.Abp.Account.Web.OpenIddict.Pages.Account
{
    [Dependency(ReplaceServices = true)]
    [ExposeServices(
        typeof(RuiChen.Abp.Account.Web.Pages.Account.LoginModel),
        typeof(OpenIddictLoginModel))]
    public class OpenIddictLoginModel : RuiChen.Abp.Account.Web.Pages.Account.LoginModel
    {
