using RuiChen.Abp.Account.OAuth.Features;
using RuiChen.Abp.Account.OAuth.Settings;
...
public class SettingAppService : ApplicationService, ISettingAppService, ISettingTestAppService
{
    ...
    protected async virtual Task<SettingGroupResult> GetAllForProviderAsync(string providerName, string providerKey)
    {
        ...
        userSetting.AddDetail(
            ...
            providerName);
        userSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister, providerName, providerKey),
            ValueType.String,
            providerName);
        userSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword, providerName, providerKey),
            ValueType.String,
            providerName);
        userSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin, providerName, providerKey),
            ValueType.String,
            providerName);
        userSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed, providerName, providerKey),
            ValueType.String,
            providerName);
        userSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval, providerName, providerKey),
            ValueType.Number,
            providerName);
        ...
        sessionSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.Session.ConcurrentLoginStrategy),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.Session.ConcurrentLoginStrategy, providerName, providerKey),
            ValueType.Option,
            providerName)
        ...
        sessionSetting.AddDetail(
            await SettingDefinitionManager.GetAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.Session.LogoutFromSameTypeDevicesLimit),
            StringLocalizerFactory,
            await SettingManager.GetOrNullAsync(RuiChen.Abp.Identity.Settings.IdentitySettingNames.Session.LogoutFromSameTypeDevicesLimit, providerName, providerKey),
            ValueType.Number,
            providerName);
