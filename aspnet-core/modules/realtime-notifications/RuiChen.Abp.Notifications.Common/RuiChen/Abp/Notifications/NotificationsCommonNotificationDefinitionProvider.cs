...
public class NotificationsCommonNotificationDefinitionProvider : NotificationDefinitionProvider
{
    public override void Define(INotificationDefinitionContext context)
    {
        ...
        commonGroup.AddNotification(
            ...
            {
                template.WithVirtualFilePath("/RuiChen/Abp/Notifications/Templates/ExceptionNotifier", isInlineLocalized: false);
            });
        ...
        tenantsGroup.AddNotification(
            ...
            .WithTemplate(template =>
            {
                template.WithVirtualFilePath("/RuiChen/Abp/Notifications/Templates/NewTenantRegisterd", isInlineLocalized: false);
            });
        ...
        usersGroup.AddNotification(
            ...
            .WithTemplate(template =>
            {
                template.WithVirtualFilePath("/RuiChen/Abp/Notifications/Templates/WelcomeToApplication", isInlineLocalized: false);
            });
    }
