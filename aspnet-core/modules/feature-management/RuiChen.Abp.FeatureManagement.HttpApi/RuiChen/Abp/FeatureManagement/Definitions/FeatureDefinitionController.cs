using RuiChen.Abp.FeatureManagement.Definitions;
using RuiChen.Abp.FeatureManagement.Permissions;
...
namespace RuiChen.Abp.FeatureManagement.HttpApi.Definitions;
