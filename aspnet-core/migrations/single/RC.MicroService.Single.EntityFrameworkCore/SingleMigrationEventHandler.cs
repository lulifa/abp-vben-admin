...
public class SingleMigrationEventHandler : EfCoreDatabaseMigrationEventHandlerBase<SingleMigrationDbContext>
{
    ...
    public SingleMigrationEventHandler(
        ...
        : base(
            ConnectionStringNameAttribute.GetConnStringName<SingleMigrationDbContext>(),
