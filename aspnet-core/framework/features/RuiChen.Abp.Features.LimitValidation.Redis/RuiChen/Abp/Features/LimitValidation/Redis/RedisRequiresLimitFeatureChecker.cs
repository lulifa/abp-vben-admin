...
{
    private const string CHECK_LUA_SCRIPT = "/RuiChen/Abp/Features/LimitValidation/Redis/Lua/check.lua";
    private const string PROCESS_LUA_SCRIPT = "/RuiChen/Abp/Features/LimitValidation/Redis/Lua/process.lua";
