...
public class BookAppService : SingleApplicationServiceBase, IBookAppService //implement the IBookAppService
{
    ...
    [Authorize(SinglePermissions.Books.Import)]
    [DisableDataProtected]// 任何人都可创建
    ...
    [Authorize(SinglePermissions.Books.Export)]
